# Elemento Individual Contributor Licence Agreement

This Contributor Licence Agreement (“Agreement”) is based on the Harmony CLA. It is
a legal agreement between you and Elemento S.r.l.
...
This Agreement covers Contributions You Submit to software projects We manage,
...
By adding Your GitHub username to `cla/SIGNERS` and submitting that change, or by
otherwise executing this Agreement, You agree to the following terms.
...
You, including copyright, moral and neighbouring rights, as appropriate, for the full
...
irrevocable patent licence, with the right to sublicense these rights to multiple
...
Material (and portions of such combination). This licence is granted only to the
