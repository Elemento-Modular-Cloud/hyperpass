...
class TerminalController with ChangeNotifier {
  ...
  /// The buffer cell where the selection started, or null if there is none.
  CellOffset? get selectionBaseOffset {
    final base = _selectionBase;
    if (base == null || !base.attached) return null;
    return base.offset;
  }

  /// The buffer cell where the selection currently ends, or null if there is none.
  CellOffset? get selectionExtentOffset {
    final extent = _selectionExtent;
    if (extent == null || !extent.attached) return null;
